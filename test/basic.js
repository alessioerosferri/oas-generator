...
describe('Server generation with a specified name', () => {
  ...
  it('Correct folders are created', () => {
    ...
    fs.existsSync(path.join(__dirname, '..', cmd.projectName, 'libs')).should.equal(true);
  });
  ...
  it('Each folder contains all necessary files', () => {
    ...
    controllersFolder.length.should.equal(2);
    ...
    const libsFolder = fs.readdirSync(path.join(__dirname, '..', cmd.projectName, 'libs'));
    libsFolder.length.should.equal(4);
    libsFolder.includes('auth.js').should.equal(true);
    libsFolder.includes('logger.js').should.equal(true);
    libsFolder.includes('metrics.js').should.equal(true);
    libsFolder.includes('oas.js').should.equal(true);
  });
...
describe('Server generation without a specified name', () => {
  ...
  it('Correct folders are created', () => {
    ...
    fs.existsSync(path.join(__dirname, '..', 'nodejs-server-generated/libs')).should.equal(true);
  });
  ...
  it('Each folder contains all necessary files', () => {
    ...
    controllersFolder.includes('petsController.js').should.equal(true);
    controllersFolder.includes('petspetIdController.js').should.equal(true);
    const libsFolder = fs.readdirSync(path.join(__dirname, '..', "nodejs-server-generated", 'libs'));
    libsFolder.length.should.equal(4);
    libsFolder.includes('auth.js').should.equal(true);
    libsFolder.includes('logger.js').should.equal(true);
    libsFolder.includes('metrics.js').should.equal(true);
